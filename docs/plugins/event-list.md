...
- [Create Server Authorization](plugins\plugin-events\create-server-auth.md)
...
- [Create Message Broker](plugins\plugin-events\create-message-broker.md)
   ...
   - [Create Message Broker Service](plugins\plugin-events\create-message-broker-service.md)
