...
## Authorize Amplication to access your GitHub account[](https://docs.amplication.com/sync-with-git-provider/#authorize-amplication-to-access-your-github-account)
...
![](./assets/sync-with-git-provider/sync-with-github.png)
...
![](./assets/sync-with-git-provider/Select-repository-2.png)
