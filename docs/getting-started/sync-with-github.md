...
2. Click the **Connect to GitHub** button in the bottom left of your project.
...
2. To view your previous commits in Amplication, select the drop down from yhe top of the page, then click **Commits**.
